        ...
        <>
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <div className="w-full flex items-center gap-3 rounded-xl border border-slate-100 bg-slate-50 px-3 py-2.5 text-left">
                <Tv2 className="w-5 h-5 text-slate-400 shrink-0" />
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-semibold text-slate-600">Ads are not part of the MVP</p>
                  <p className="text-[11px] text-slate-400">Use missions, badge sharing, or invites to earn more hearts.</p>
                </div>
              </div>
            </div>
